...
YES! I have used PeerJS Library here For Peer to Peer Connection which itself Using WEBRTC.
- You can find more on official PeerJS docs ( https://peerjs.com ).

I have deployed this project on Heroku, So there is a need to change index(home page - HTML page) into php file to trick Heroku to consider it as php page
